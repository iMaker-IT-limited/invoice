...
let AngularFireAuth = class AngularFireAuth {
    constructor(options, nameOrConfig, platformId, zone) {
        this.zone = zone;
        const scheduler = new _angular_fire__WEBPACK_IMPORTED_MODULE_3__["FirebaseZoneScheduler"](zone, platformId);
        this.auth = zone.runOutsideAngular(() => {
            const app = Object(_angular_fire__WEBPACK_IMPORTED_MODULE_3__["_firebaseAppFactory"])(options, zone, nameOrConfig);
            return app.auth();
        });
        this.authState = scheduler.keepUnstableUntilFirst(scheduler.runOutsideAngular(new rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"](subscriber => {
            const unsubscribe = this.auth.onAuthStateChanged(subscriber);
            return { unsubscribe };
        })));
        this.user = scheduler.keepUnstableUntilFirst(scheduler.runOutsideAngular(new rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"](subscriber => {
            const unsubscribe = this.auth.onIdTokenChanged(subscriber);
            return { unsubscribe };
        })));
        this.idToken = this.user.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(user => {
        ...
        this.idTokenResult = this.user.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(user => {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _auth__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./auth */ "./node_modules/@angular/fire/auth/es2015/auth.js");
...
let AngularFireAuthModule = class AngularFireAuthModule {
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _public_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./public_api */ "./node_modules/@angular/fire/auth/es2015/public_api.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _auth__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./auth */ "./node_modules/@angular/fire/auth/es2015/auth.js");
...
/* harmony import */ var _auth_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./auth.module */ "./node_modules/@angular/fire/auth/es2015/auth.module.js");
...
let FormAlertPageModule = class FormAlertPageModule {
};
...
let FormAlertPage = class FormAlertPage {
    constructor(toastCtrl, navParams, navCtrl, firebaseService, authService, modalCtrl, storage, alertCtrl) {
    ...
    */
    ...
    // }
    submitFilterForm() {
        firebase__WEBPACK_IMPORTED_MODULE_7__["auth"]().onAuthStateChanged(user => {
            if (user) {
                // User is signed in.
                this.uid = user.uid;
                ...
                console.log("user not logged in:", this.uid, this.data, this.FilterForm.value);
                const arr = [];
...
const firebaseRoutes = [
    // { path: 'company-profile', loadChildren: './firebase/company_profile/company-profile/company-profile.module#CompanyProfilePageModule' },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | firebase-company_profile-company-profile-company-profile-module */ "firebase-company_profile-company-profile-company-profile-module").then(__webpack_require__.bind(null, /*! ./../firebase/company_profile/company-profile/company-profile.module */ "./src/app/firebase/company_profile/company-profile/company-profile.module.ts")).then(m => m.CompanyProfilePageModule)
    },
    ...
    //  { path: 'create', loadChildren: './firebase/creditnotes/create/create.module#CreatePageModule' },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | firebase-creditnotes-create-create-module */ "firebase-creditnotes-create-create-module").then(__webpack_require__.bind(null, /*! ./../firebase/creditnotes/create/create.module */ "./src/app/firebase/creditnotes/create/create.module.ts")).then(m => m.CreatePageModule)
    },
    // { path: 'details', loadChildren: './firebase/creditnotes/details/details.module#DetailsPageModule' },
    {
        path: "creditnotes#details",
        loadChildren: () => Promise.all(/*! import() | firebase-creditnotes-details-details-module */[__webpack_require__.e("default~alerts-form-results-form-results-module~firebase-contacts-contacts-contacts-module~firebase-~398d1e07"), __webpack_require__.e("default~firebase-creditnotes-details-details-module~firebase-expenses-create-create-module~firebase-~504f60cb"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-contacts-details-details-module~firebase~9842f28e"), __webpack_require__.e("firebase-creditnotes-details-details-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/creditnotes/details/details.module */ "./src/app/firebase/creditnotes/details/details.module.ts")).then(m => m.DetailsPageModule)
    },
    // { path: 'creditnotes', loadChildren: './firebase/creditnotes/creditnotes/creditnotes.module#CreditnotesPageModule' },
    {
        path: "creditnotes",
        loadChildren: () => Promise.all(/*! import() | firebase-creditnotes-creditnotes-creditnotes-module */[__webpack_require__.e("default~alerts-form-results-form-results-module~firebase-contacts-contacts-contacts-module~firebase-~398d1e07"), __webpack_require__.e("firebase-creditnotes-creditnotes-creditnotes-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/creditnotes/creditnotes/creditnotes.module */ "./src/app/firebase/creditnotes/creditnotes/creditnotes.module.ts")).then(m => m.CreditnotesPageModule)
    },
    // { path: 'update', loadChildren: './firebase/creditnotes/update/update.module#UpdatePageModule' },
    {
        path: "creditnotes#update",
        loadChildren: () => __webpack_require__.e(/*! import() | firebase-creditnotes-update-update-module */ "firebase-creditnotes-update-update-module").then(__webpack_require__.bind(null, /*! ./../firebase/creditnotes/update/update.module */ "./src/app/firebase/creditnotes/update/update.module.ts")).then(m => m.UpdatePageModule)
    },
    // { path: 'create', loadChildren: './firebase/paymentsrec/create/create.module#CreatePageModule' },
    {
        path: "paymentsrec#create",
        loadChildren: () => Promise.all(/*! import() | firebase-paymentsrec-create-create-module */[__webpack_require__.e("default~firebase-creditnotes-details-details-module~firebase-expenses-create-create-module~firebase-~504f60cb"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-expenses-create-create-module~firebase-e~3796ff9c"), __webpack_require__.e("common"), __webpack_require__.e("firebase-paymentsrec-create-create-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/paymentsrec/create/create.module */ "./src/app/firebase/paymentsrec/create/create.module.ts")).then(m => m.CreatePageModule)
    },
    // { path: 'details', loadChildren: './firebase/paymentsrec/details/details.module#DetailsPageModule' },
    {
        path: "paymentsrec#details",
        loadChildren: () => Promise.all(/*! import() | firebase-paymentsrec-details-details-module */[__webpack_require__.e("default~alerts-form-results-form-results-module~firebase-contacts-contacts-contacts-module~firebase-~398d1e07"), __webpack_require__.e("default~firebase-creditnotes-details-details-module~firebase-expenses-create-create-module~firebase-~504f60cb"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-contacts-details-details-module~firebase~9842f28e"), __webpack_require__.e("firebase-paymentsrec-details-details-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/paymentsrec/details/details.module */ "./src/app/firebase/paymentsrec/details/details.module.ts")).then(m => m.DetailsPageModule)
    },
    // { path: 'paymentsrec', loadChildren: './firebase/paymentsrec/paymentsrec/paymentsrec.module#PaymentsrecPageModule' },
    {
        path: "paymentsrec",
        loadChildren: () => Promise.all(/*! import() | firebase-paymentsrec-paymentsrec-paymentsrec-module */[__webpack_require__.e("default~alerts-form-results-form-results-module~firebase-contacts-contacts-contacts-module~firebase-~398d1e07"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-inventory-items-items-module~firebase-in~98ea33f5"), __webpack_require__.e("firebase-paymentsrec-paymentsrec-paymentsrec-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/paymentsrec/paymentsrec/paymentsrec.module */ "./src/app/firebase/paymentsrec/paymentsrec/paymentsrec.module.ts")).then(m => m.PaymentsrecPageModule)
    },
    // { path: 'update', loadChildren: './firebase/paymentsrec/update/update.module#UpdatePageModule' },
    {
        path: "paymentsrec#update",
        loadChildren: () => __webpack_require__.e(/*! import() | firebase-paymentsrec-update-update-module */ "firebase-paymentsrec-update-update-module").then(__webpack_require__.bind(null, /*! ./../firebase/paymentsrec/update/update.module */ "./src/app/firebase/paymentsrec/update/update.module.ts")).then(m => m.UpdatePageModule)
    },
    // { path: 'details', loadChildren: './firebase/contacts/details/details.module#DetailsPageModule' },
    {
        path: "contacts#details",
        loadChildren: () => Promise.all(/*! import() | firebase-contacts-details-details-module */[__webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-contacts-details-details-module~firebase~9842f28e"), __webpack_require__.e("default~firebase-contacts-details-details-module~user-profile-user-profile-module"), __webpack_require__.e("firebase-contacts-details-details-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/contacts/details/details.module */ "./src/app/firebase/contacts/details/details.module.ts")).then(m => m.DetailsPageModule)
    },
    // { path: 'details', loadChildren: './firebase/inventory/details/details.module#DetailsPageModule' },
    {
        path: "inventory#details",
        loadChildren: () => Promise.all(/*! import() | firebase-inventory-details-details-module */[__webpack_require__.e("default~firebase-creditnotes-details-details-module~firebase-expenses-create-create-module~firebase-~504f60cb"), __webpack_require__.e("default~firebase-inventory-details-details-module~firebase-inventory-items-items-module"), __webpack_require__.e("firebase-inventory-details-details-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/inventory/details/details.module */ "./src/app/firebase/inventory/details/details.module.ts")).then(m => m.DetailsPageModule)
    },
    //  { path: 'quotes#details', loadChildren: './firebase/quotes/details/details.module#DetailsPageModule' },
    {
        path: "quotes#details",
        loadChildren: () => Promise.all(/*! import() | firebase-quotes-details-details-module */[__webpack_require__.e("default~alerts-form-results-form-results-module~firebase-contacts-contacts-contacts-module~firebase-~398d1e07"), __webpack_require__.e("default~firebase-creditnotes-details-details-module~firebase-expenses-create-create-module~firebase-~504f60cb"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-contacts-details-details-module~firebase~9842f28e"), __webpack_require__.e("firebase-quotes-details-details-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/quotes/details/details.module */ "./src/app/firebase/quotes/details/details.module.ts")).then(m => m.DetailsPageModule)
    },
    //  { path: 'invoices#details', loadChildren: './firebase/invoices/details/details.module#DetailsPageModule' },
    {
        path: "invoices#details",
        loadChildren: () => Promise.all(/*! import() | firebase-invoices-details-details-module */[__webpack_require__.e("default~alerts-form-results-form-results-module~firebase-contacts-contacts-contacts-module~firebase-~398d1e07"), __webpack_require__.e("default~firebase-creditnotes-details-details-module~firebase-expenses-create-create-module~firebase-~504f60cb"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-contacts-details-details-module~firebase~9842f28e"), __webpack_require__.e("firebase-invoices-details-details-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/invoices/details/details.module */ "./src/app/firebase/invoices/details/details.module.ts")).then(m => m.DetailsPageModule)
    },
    // copy user-profile
    {
        path: "contacts",
        loadChildren: () => Promise.all(/*! import() | firebase-contacts-contacts-contacts-module */[__webpack_require__.e("default~alerts-form-results-form-results-module~firebase-contacts-contacts-contacts-module~firebase-~398d1e07"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-expenses-create-create-module~firebase-e~3796ff9c"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-contacts-details-details-module~firebase~9842f28e"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-inventory-items-items-module~firebase-in~98ea33f5"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-invoices-invoices-invoices-module~user-p~00f521db"), __webpack_require__.e("firebase-contacts-contacts-contacts-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/contacts/contacts/contacts.module */ "./src/app/firebase/contacts/contacts/contacts.module.ts")).then(m => m.ContactsPageModule)
    },
    //  { path: 'contacts', loadChildren: './../firebase/contacts/contacts/contacts.module#ContactsPageModule' },
    {
        path: "quotes",
        loadChildren: () => Promise.all(/*! import() | firebase-quotes-quotes-quotes-module */[__webpack_require__.e("default~alerts-form-results-form-results-module~firebase-contacts-contacts-contacts-module~firebase-~398d1e07"), __webpack_require__.e("firebase-quotes-quotes-quotes-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/quotes/quotes/quotes.module */ "./src/app/firebase/quotes/quotes/quotes.module.ts")).then(m => m.QuotesPageModule)
    },
    // { path: 'quotes', loadChildren: './../firebase/quotes/quotes/quotes.module#QuotesPageModule' },
    {
        path: "invoices",
        loadChildren: () => Promise.all(/*! import() | firebase-invoices-invoices-invoices-module */[__webpack_require__.e("default~alerts-form-results-form-results-module~firebase-contacts-contacts-contacts-module~firebase-~398d1e07"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-inventory-items-items-module~firebase-in~98ea33f5"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-invoices-invoices-invoices-module~user-p~00f521db"), __webpack_require__.e("firebase-invoices-invoices-invoices-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/invoices/invoices/invoices.module */ "./src/app/firebase/invoices/invoices/invoices.module.ts")).then(m => m.InvoicesPageModule)
    },
    // { path: 'expenses', loadChildren: './firebase/expenses/expenses/expenses.module#ExpensesPageModule' },
    {
        path: "expenses",
        loadChildren: () => Promise.all(/*! import() | firebase-expenses-expenses-expenses-module */[__webpack_require__.e("default~alerts-form-results-form-results-module~firebase-contacts-contacts-contacts-module~firebase-~398d1e07"), __webpack_require__.e("firebase-expenses-expenses-expenses-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/expenses/expenses/expenses.module */ "./src/app/firebase/expenses/expenses/expenses.module.ts")).then(m => m.ExpensesPageModule)
    },
    // { path: 'create', loadChildren: './firebase/expenses/create/create.module#CreatePageModule' },
    {
        path: "create#expenses",
        loadChildren: () => Promise.all(/*! import() | firebase-expenses-create-create-module */[__webpack_require__.e("default~firebase-creditnotes-details-details-module~firebase-expenses-create-create-module~firebase-~504f60cb"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-expenses-create-create-module~firebase-e~3796ff9c"), __webpack_require__.e("common"), __webpack_require__.e("firebase-expenses-create-create-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/expenses/create/create.module */ "./src/app/firebase/expenses/create/create.module.ts")).then(m => m.CreatePageModule)
    },
    // { path: 'create', loadChildren: './firebase/expenses/create/create.module#CreatePageModule' },
    {
        path: "update#expenses",
        loadChildren: () => Promise.all(/*! import() | firebase-expenses-update-update-module */[__webpack_require__.e("default~firebase-creditnotes-details-details-module~firebase-expenses-create-create-module~firebase-~504f60cb"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-expenses-create-create-module~firebase-e~3796ff9c"), __webpack_require__.e("common"), __webpack_require__.e("firebase-expenses-update-update-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/expenses/update/update.module */ "./src/app/firebase/expenses/update/update.module.ts")).then(m => m.UpdatePageModule)
    },
    // { path: 'update', loadChildren: './firebase/expenses/update/update.module#UpdatePageModule' },
    {
        path: "details#expenses",
        loadChildren: () => Promise.all(/*! import() | firebase-expenses-details-details-module */[__webpack_require__.e("default~alerts-form-results-form-results-module~firebase-contacts-contacts-contacts-module~firebase-~398d1e07"), __webpack_require__.e("default~firebase-creditnotes-details-details-module~firebase-expenses-create-create-module~firebase-~504f60cb"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-contacts-details-details-module~firebase~9842f28e"), __webpack_require__.e("firebase-expenses-details-details-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/expenses/details/details.module */ "./src/app/firebase/expenses/details/details.module.ts")).then(m => m.DetailsPageModule)
    },
    ...
    // { path: 'invoices', loadChildren: './../firebase/invoices/invoices/invoices.module#InvoicesPageModule' },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | firebase-inventory-items-items-module */[__webpack_require__.e("default~alerts-form-results-form-results-module~firebase-contacts-contacts-contacts-module~firebase-~398d1e07"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-inventory-items-items-module~firebase-in~98ea33f5"), __webpack_require__.e("default~firebase-inventory-details-details-module~firebase-inventory-items-items-module"), __webpack_require__.e("firebase-inventory-items-items-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/inventory/items/items.module */ "./src/app/firebase/inventory/items/items.module.ts")).then(m => m.ItemsPageModule)
    },
    //  { path: 'inventory/items', loadChildren: './../firebase/inventory/items/items.module#ItemsPageModule' },
    {
        path: "update#contacts",
        loadChildren: () => __webpack_require__.e(/*! import() | firebase-contacts-update-update-module */ "firebase-contacts-update-update-module").then(__webpack_require__.bind(null, /*! ./../firebase/contacts/update/update.module */ "./src/app/firebase/contacts/update/update.module.ts")).then(m => m.UpdatePageModule)
    },
    // { path: 'update#contacts', loadChildren: './../firebase/contacts/update/update.module#UpdatePageModule' },
    {
        path: "create#contacts",
        loadChildren: () => Promise.all(/*! import() | firebase-contacts-create-create-module */[__webpack_require__.e("default~alerts-form-results-form-results-module~firebase-contacts-contacts-contacts-module~firebase-~398d1e07"), __webpack_require__.e("firebase-contacts-create-create-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/contacts/create/create.module */ "./src/app/firebase/contacts/create/create.module.ts")).then(m => m.CreatePageModule)
    },
    { path: 'create#contacts', loadChildren: './../firebase/contacts/create/create.module#CreatePageModule' },
    {
        path: "create#inventory",
        loadChildren: () => Promise.all(/*! import() | firebase-inventory-create-create-module */[__webpack_require__.e("common"), __webpack_require__.e("firebase-inventory-create-create-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/inventory/create/create.module */ "./src/app/firebase/inventory/create/create.module.ts")).then(m => m.CreatePageModule)
    },
    // { path: 'create#inventory', loadChildren: './../firebase/inventory/create/create.module#CreatePageModule' },
    {
        path: "update#inventory",
        loadChildren: () => Promise.all(/*! import() | firebase-inventory-update-update-module */[__webpack_require__.e("common"), __webpack_require__.e("firebase-inventory-update-update-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/inventory/update/update.module */ "./src/app/firebase/inventory/update/update.module.ts")).then(m => m.UpdatePageModule)
    },
    // { path: 'update#inventory', loadChildren: './../firebase/inventory/update/update.module#UpdatePageModule' },
    {
        path: "create#invoices",
        loadChildren: () => Promise.all(/*! import() | firebase-invoices-create-create-module */[__webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-expenses-create-create-module~firebase-e~3796ff9c"), __webpack_require__.e("common"), __webpack_require__.e("firebase-invoices-create-create-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/invoices/create/create.module */ "./src/app/firebase/invoices/create/create.module.ts")).then(m => m.CreatePageModule)
    },
    // { path: 'create#invoices', loadChildren: './../firebase/invoices/create/create.module#CreatePageModule' },
    {
        path: "update#invoices",
        loadChildren: () => Promise.all(/*! import() | firebase-invoices-update-update-module */[__webpack_require__.e("default~firebase-creditnotes-details-details-module~firebase-expenses-create-create-module~firebase-~504f60cb"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-expenses-create-create-module~firebase-e~3796ff9c"), __webpack_require__.e("common"), __webpack_require__.e("firebase-invoices-update-update-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/invoices/update/update.module */ "./src/app/firebase/invoices/update/update.module.ts")).then(m => m.UpdatePageModule)
    },
    // { path: 'update#invoices', loadChildren: './../firebase/invoices/update/update.module#UpdatePageModule' },
    {
        path: "create#quotes",
        loadChildren: () => Promise.all(/*! import() | firebase-quotes-create-create-module */[__webpack_require__.e("default~firebase-creditnotes-details-details-module~firebase-expenses-create-create-module~firebase-~504f60cb"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-expenses-create-create-module~firebase-e~3796ff9c"), __webpack_require__.e("common"), __webpack_require__.e("firebase-quotes-create-create-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/quotes/create/create.module */ "./src/app/firebase/quotes/create/create.module.ts")).then(m => m.CreatePageModule)
    },
    // { path: 'create#quotes', loadChildren: './../firebase/quotes/create/create.module#CreatePageModule' },
    {
        path: "update#quotes",
        loadChildren: () => Promise.all(/*! import() | firebase-quotes-update-update-module */[__webpack_require__.e("default~firebase-creditnotes-details-details-module~firebase-expenses-create-create-module~firebase-~504f60cb"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-expenses-create-create-module~firebase-e~3796ff9c"), __webpack_require__.e("common"), __webpack_require__.e("firebase-quotes-update-update-module")]).then(__webpack_require__.bind(null, /*! ./../firebase/quotes/update/update.module */ "./src/app/firebase/quotes/update/update.module.ts")).then(m => m.UpdatePageModule)
    },
    // { path: 'update#quotes', loadChildren: './../firebase/quotes/update/update.module#UpdatePageModule' },
    {
        path: "user-profile",
        loadChildren: () => Promise.all(/*! import() | user-profile-user-profile-module */[__webpack_require__.e("default~alerts-form-results-form-results-module~firebase-contacts-contacts-contacts-module~firebase-~398d1e07"), __webpack_require__.e("default~firebase-contacts-contacts-contacts-module~firebase-invoices-invoices-invoices-module~user-p~00f521db"), __webpack_require__.e("default~firebase-contacts-details-details-module~user-profile-user-profile-module"), __webpack_require__.e("user-profile-user-profile-module")]).then(__webpack_require__.bind(null, /*! ./../user/profile/user-profile.module */ "./src/app/user/profile/user-profile.module.ts")).then(m => m.UserProfilePageModule)
    }, {
        path: "categories",
    ...
    {
        path: "form",
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./../alerts/form/form.module */ "./src/app/alerts/form/form.module.ts")).then(m => m.FormPageModule)
    },
    {
        path: "form-results",
        loadChildren: () => Promise.all(/*! import() | alerts-form-results-form-results-module */[__webpack_require__.e("default~alerts-form-results-form-results-module~firebase-contacts-contacts-contacts-module~firebase-~398d1e07"), __webpack_require__.e("alerts-form-results-form-results-module")]).then(__webpack_require__.bind(null, /*! ./../alerts/form-results/form-results.module */ "./src/app/alerts/form-results/form-results.module.ts")).then(m => m.FormResultsPageModule)
    },
    {
        path: "getting-started",
        loadChildren: () => __webpack_require__.e(/*! import() | getting-started-getting-started-module */ "getting-started-getting-started-module").then(__webpack_require__.bind(null, /*! ./../getting-started/getting-started.module */ "./src/app/getting-started/getting-started.module.ts")).then(m => m.GettingStartedPageModule)
    },
    {
        path: "user-friends",
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./../user/friends/user-friends.module */ "./src/app/user/friends/user-friends.module.ts")).then(m => m.UserFriendsPageModule)
    },
    {
        path: "notifications",
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./../notifications/notifications.module */ "./src/app/notifications/notifications.module.ts")).then(m => m.NotificationsPageModule)
    }
];
...
class FirebaseEnquiryModel extends _shell_data_store__WEBPACK_IMPORTED_MODULE_0__["ShellModel"] {
    constructor() {
        super();
    }
}
class FirebaseSupplierModel extends _shell_data_store__WEBPACK_IMPORTED_MODULE_0__["ShellModel"] {
    constructor() {
        super();
    }
}
// assign 'teacher' or 'supplier'
class FirebaseRoleModel extends _shell_data_store__WEBPACK_IMPORTED_MODULE_0__["ShellModel"] {
    constructor() {
        super();
    }
}
...
let FirebaseUpdateUserModal = class FirebaseUpdateUserModal {
    constructor(modalController, alertController, firebaseService, router) {
        this.modalController = modalController;
