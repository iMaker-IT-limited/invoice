...
var DetailsPage = /** @class */ (function () {
    function DetailsPage(authService, route, navCtrl, firebaseService) {
    ...
    DetailsPage.prototype.onChange = function ($event) {
        var file = $event.target['files'][0];
        console.log('file is: ', file);
        this.convertToBase64(file);
    };
    DetailsPage.prototype.convertToBase64 = function (file) {
        var _this = this;
        this.myimage = new rxjs__WEBPACK_IMPORTED_MODULE_9__["Observable"](function (subscriber) {
    ...
    DetailsPage.prototype.readFile = function (file, subscriber) {
    ...
    DetailsPage.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (data) {
            ...
            var results = JSON.parse(data.datas);
            _this.estimateList = results;
            _this.estimateDetail = result;
            console.log(_this.estimateDetail);
        });
    ...
    DetailsPage.prototype.returnSum = function () {
        console.log(this.estimateDetail, this.estimateDetail.salesList);
        return this.estimateDetail.salesList.reduce(function (sum, i) {
    ...
    DetailsPage.prototype.handleInputChange = function () {
        this.totalPrice = this.returnSum();
        console.log(this.totalPrice);
    };
    DetailsPage.prototype.createPDF = function () {
    ...
    DetailsPage.prototype.testtablePDF = function (value) {
        console.log(value);
    ...
    DetailsPage.prototype.showSideNav = function (value) {
        console.log(value);
        if (value == true) {
    ...
    DetailsPage.prototype.onDismiss = function () {
        this.navCtrl.back();
    };
    DetailsPage.prototype.getCompanyProfile = function () {
        var _this = this;
    ...
    DetailsPage.prototype.getLogisticCompanyProfile = function () {
        var _this = this;
        console.log(this.email, this.uid);
    ...
    //   })
    // }
    DetailsPage.prototype.updateEstimate = function () {
        console.log(this.email, this.uid, this.estimateDetail);
        var data = JSON.stringify(this.estimateDetail);
        console.log(data);
    ...
    DetailsPage.prototype.deleteItem = function () {
        var _this = this;
        console.log(this.estimateDetail, this.email, this.uid);
        this.firebaseService.deleteEstimates(this.estimateDetail.id, this.uid, this.email).then(function () {
            _this.onDismiss();
        });
    };
    DetailsPage.prototype.returnProduct = function (x, y) {
        return x * y;
    };
    DetailsPage.prototype.convertToInvoice = function (value) {
...
//# sourceMappingURL=firebase-quotes-details-details-module-es5.js.map