    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            path: "fashion",
            loadChildren: () =>
              import("../fashion/listing/fashion-listing.module").then(
          ...
          },
          {
            ...
            loadChildren: () =>
              import("../fashion/details/fashion-details.module").then(
                m => m.FashionDetailsPageModule
              )
          },
          {
            path: "food",
            loadChildren: () =>
              import("../food/listing/food-listing.module").then(
                m => m.FoodListingPageModule
              )
          },
          {
            path: "food/:productId",
          ...
          },
          {
            path: "travel",
            loadChildren: () =>
              import("../travel/listing/travel-listing.module").then(
                m => m.TravelListingPageModule
              )
          },
          {
          ...
          },
          {
            ...
            loadChildren: () =>
              import("../deals/details/deals-details.module").then(
