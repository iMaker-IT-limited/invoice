...
// creditpayments
import creditpaymentsdata from './../../../../assets/credit_notes.json';

import data from './../../../../assets/credit_notes.json';
...
export class CreditnotesPage implements OnInit {
  ...
  // ngx-table start
  private credit_notes = creditpaymentsdata;
  ...
  constructor(
    ...
    console.log(this.companies, this.credit_notes);
    const arr = [];
    for (var i = 0; i < 10; i++) {
  ...
  // ngx - table end
  onCreateCreditNotes() {
    this.navCtrl.navigateRoot(["/firebase/creditnotes#create"]);
  }
  ...
  onDetailPage(value) {
    ...
    this.navCtrl.navigateRoot(["/firebase/creditnotes#details"], navigationExtras);
  }
