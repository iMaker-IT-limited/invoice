...
let BlockingResovlersPage = class BlockingResovlersPage {
    constructor(route) {
        this.route = route;
    }
    ngOnInit() {
...
BlockingResovlersPage.ctorParameters = () => [
...
let BlockingResolver = class BlockingResolver {
...
BlockingResolver.ctorParameters = () => [
...
let NonBlockingResolversPage = class NonBlockingResolversPage {
    constructor(route) {
        this.route = route;
    }
    ngOnInit() {
...
NonBlockingResolversPage.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
...
let NonBlockingResolver = class NonBlockingResolver {
...
NonBlockingResolver.ctorParameters = () => [
...
let ProgressiveShellResovlersPage = class ProgressiveShellResovlersPage {
    constructor(route) {
        this.route = route;
    }
    ngOnInit() {
...
ProgressiveShellResovlersPage.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
...
let ProgressiveShellResolver = class ProgressiveShellResolver {
    constructor(showcaseService) {
        this.showcaseService = showcaseService;
    }
    resolve() {
...
ProgressiveShellResolver.ctorParameters = () => [
    { type: _showcase_service__WEBPACK_IMPORTED_MODULE_2__["ShowcaseService"] }
];
...
let RouteResolversUXModule = class RouteResolversUXModule {
};
...
let RouteResovlersUXPage = class RouteResovlersUXPage {
    constructor() { }
};
...
//# sourceMappingURL=route-resolvers-ux-route-resolvers-ux-module-es2015.js.map