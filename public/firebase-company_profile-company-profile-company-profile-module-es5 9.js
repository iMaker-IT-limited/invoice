...
var CompanyProfilePage = /** @class */ (function () {
    ...
    CompanyProfilePage.prototype.createCompanyProfile = function () {
        ...
        this.firebaseService.createCompanyProfile(this.uid, this.email, this.createCompanyProfileForm.value).then(function () {
            _this.dismissModal();
        });
    };
    CompanyProfilePage.prototype.createTermsandConditions = function () {
        ...
        this.firebaseService.createTermsandConditions(this.uid, this.email, this.createTermsandConditionsForm.value).then(function () {
            _this.dismissModal();
        });
    };
    CompanyProfilePage.prototype.createCustomerNotes = function () {
        ...
        this.firebaseService.createCustomerNotes(this.uid, this.email, this.createCustomerNotesForm.value).then(function () {
            _this.dismissModal();
        });
    };
