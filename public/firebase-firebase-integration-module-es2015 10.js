...
const firebaseRoutes = [
    ...
    // { path: 'create', loadChildren: './firebase/paymentsrec/create/create.module#CreatePageModule' },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | firebase-paymentsrec-create-create-module */ "firebase-paymentsrec-create-create-module").then(__webpack_require__.bind(null, /*! ./../firebase/paymentsrec/create/create.module */ "./src/app/firebase/paymentsrec/create/create.module.ts")).then(m => m.CreatePageModule)
    },
