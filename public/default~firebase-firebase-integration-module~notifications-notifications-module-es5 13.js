...
var NotificationsPage = /** @class */ (function () {
    function NotificationsPage(http, route, firebaseService) {
        this.http = http;
        this.route = route;
    ...
    NotificationsPage.prototype.ngOnInit = function () {
        ...
        this.http.get('https://sheet.best/api/sheets/4f29fe18-7501-495b-b89b-80629543d791').subscribe(function (res) {
            console.log(res);
            _this.restNotifications = res;
        });
    };
...
//# sourceMappingURL=default~firebase-firebase-integration-module~notifications-notifications-module-es5.js.map