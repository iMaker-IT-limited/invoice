...
var CompanyProfilePage = /** @class */ (function () {
    ...
    // CRUD
    CompanyProfilePage.prototype.createLogisticCompanyProfile = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                        ...
                                        handler: function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                            ...
                                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
                                                        //            this.createCompanyProfileForm.value["logo_base64Image"] = this.base64Image;
                                                        this.firebaseService.createLogisticCompanyProfile(this.uid, this.email, this.createLogisticCompanyProfileForm.value).then(function (res) {
                                                            _this.getLogisticCompanyProfile();
                                                        });
                                                        return [4 /*yield*/, this.toastController.create({
                                                                message: 'Your settings have been saved.',
                                                                mode: 'ios',
    ...
    CompanyProfilePage.prototype.getLogisticCompanyProfile = function () {
        var _this = this;
        console.log(this.email, this.uid);
