...
var CreatePage = /** @class */ (function () {
    function CreatePage(authService, navCtrl, firebaseService) {
    ...
    CreatePage.prototype.createItem = function () {
        var _this = this;
        ...
        this.firebaseService.createItems(this.uid, this.email, this.createItemForm.value).then(function () {
            _this.dismissModal();
        });
    };
...
//# sourceMappingURL=firebase-inventory-create-create-module-es5.js.map