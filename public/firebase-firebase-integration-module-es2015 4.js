...
const firebaseRoutes = [
    ...
    {
        path: "form-results",
        loadChildren: () => Promise.all(/*! import() | alerts-form-results-form-results-module */[__webpack_require__.e("default~alerts-form-results-form-results-module~firebase-contacts-contacts-contacts-module~firebase-~2eefff02"), __webpack_require__.e("alerts-form-results-form-results-module")]).then(__webpack_require__.bind(null, /*! ./../alerts/form-results/form-results.module */ "./src/app/alerts/form-results/form-results.module.ts")).then(m => m.FormResultsPageModule)
    },
    {
