...
var FirebaseUserDetailsPage = /** @class */ (function () {
    ...
    FirebaseUserDetailsPage.prototype.ngOnInit = function () {
        ...
        this.route.data.subscribe(function (resolvedRouteData) {
            ...
            var userId = resolvedDataStores.userId;
            _this.userId = userId;
    ...
    FirebaseUserDetailsPage.prototype.ionViewDidEnter = function () {
        // this.navParams.get("data").subscribe(res => {
        //   console.log(res);
        // });
    };
    FirebaseUserDetailsPage.prototype.updateSupplier = function () {
        // this.firebaseService.updateSupplier(this.userId);
    };
    FirebaseUserDetailsPage.prototype.changeTargetValue = function (value) {
        switch (true) {
            case value === 1:
                return "K1";
            case value === 2:
...
var FirebaseUserDetailsResolver = /** @class */ (function () {
    function FirebaseUserDetailsResolver() {
    }
