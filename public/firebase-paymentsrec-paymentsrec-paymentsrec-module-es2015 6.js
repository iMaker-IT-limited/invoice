...
let PaymentsrecPageModule = class PaymentsrecPageModule {
};
...
let PaymentsrecPage = class PaymentsrecPage {
    ...
    readPaymentReceived() {
        ...
        this.firebaseService.readPaymentReceived(this.uid, this.email).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["map"])(changes => changes.map(c => (Object.assign({ id: c.payload.doc.id }, c.payload.doc.data()))))).subscribe(data => {
            this.paymentreceivedList = data;
            console.log(this.paymentreceivedList);
        });
    }
};
PaymentsrecPage.ctorParameters = () => [
...
//# sourceMappingURL=firebase-paymentsrec-paymentsrec-paymentsrec-module-es2015.js.map